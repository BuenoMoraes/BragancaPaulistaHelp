...
delete from usuario where login = 'giovannata';
delete from usuario where senha = 257;
delete from usuario where idUser = 4;

delete from problema where idProblema =  3;
delete from problema where data = '2019-07-11';
delete from problema where tipo = 'falta de agua';
